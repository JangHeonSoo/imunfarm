...
1. Break it into steps. Asking for everything at once produces mediocre results. "First, analyze the trends" → "Now suggest a strategy based on that analysis."
2. Request comparisons. "Give me one emotional version and one feature-focused version." Options are power.
3. Specify tone. "Casual for college students" vs. "Formal for investors." Same content, completely different output.
4. Iterate with feedback. If the first answer is 80%, refine: "Make this shorter," "Add a concrete example." Don't expect perfection on the first try.
5. Try meta-prompting. Ask the AI: "What prompt should I use to get a better answer on this topic?" Paradoxical, but incredibly effective.
